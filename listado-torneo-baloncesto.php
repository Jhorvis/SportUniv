...
foreach($data as $r){ 
  ...
  echo "<td ><a style='font-size:20px;' href='resultado-listado-torneo-baloncesto.php?id=$r->idtorneo';\"><img src='img/basquet-icono-300x241.jpg' width='66'> $r->nombretorneo</a></td>";
...
<td>
   <BR><BR><BR>
  <a href="listado.php" style="margin-left:20px;"><span class="glyphicon glyphicon-arrow-left" style="font-size:24px;"></span></a> <br><br>
