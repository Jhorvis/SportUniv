...
$data=$a->Printf_Voleibol($_SESSION['identidad']);
...
<td width="78%" >
 ...
 <table width="100%" border="0"      style="background-color:#fff;">
  <tr>
    <td colspan="3"><h3  ><span style="margin-left:20px;" ><b style="font-family:bold;"> IMPRIMIR PLANILLA DE VOLEIBOL</b></span></h3>   
</td>
...
<br><br><br>
 <form method="POST" action="imprimir-voleibol.php"> 
