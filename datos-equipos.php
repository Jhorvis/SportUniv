...
<div align="center">
<br>
 <a href="nuevo-equipo.php" class="btn btn-primary" >Volver Atras</a>
...
<?php exit(); }else{ 
 ...
 if ($a->verifequipo($_POST['torneo'],$_POST ['nombrequipo'])){
...
<tr><td>
 <center><img src="img/errors.png" width="120" ></center>
<p><br><center><h4>Ya existe un equipo con este nombre, por favor seleccione otro!</h4></center></p> 
...
<form method="post" action="nuevo-equipo.php">
...
<input type="hidden"   class="form-control" name="disciplina"  value="Futbol Sala" required>
...
<td>
  ...
  <a href="nuevo-equipo.php" style="margin-left:20px;"><span class="glyphicon glyphicon-arrow-left" style="font-size:24px;"></span></a> <br><br>
