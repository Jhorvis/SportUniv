...
$audit->insauditoria($admin, $_SESSION['identidad'],"Modificó el registro del estudiante: <font color=blue><i>" .$_POST['cedula']. " " .$_POST['nombre'] ." " .$_POST['apellido']. "</i></font>", " Usuario: " .$_SESSION['user'], "".$_SERVER['REMOTE_ADDR']);
...
';
        ...
        $modificarest = "SELECT * FROM estudiante where idregistro = $id";
...
<td><label for="nombre"  >Nombres:</label></td><td><input  autofocus autocomplete="off" onkeypress="txNombres()" class="form-control" name="nombre" type="text" value="<?php echo $result ['nombre']; ?>"required></td>
<td><label for="apellido">Apellidos:</label></td><td><input  autocomplete="off" onkeypress="txNombres()" class="form-control" name="apellido" type="text" 
value="<?php echo $result ['apellido']; ?>" required></td>
...
<td><label for="cedula">Cedula:</label></td><td><input  autocomplete="off" onkeypress="ValidaSoloNumeros()" class="form-control" name="cedula" type="text" value="<?php echo $result ['cedula']; ?>" required></td>
<td><label for="telefono">Telefono:</label></td><td><input  autocomplete="off" class="form-control" value="<?php echo $result ['telefono']; ?>" name="telefono" type="text"  onkeypress="ValidaSoloNumeros()" required></td>
...
<td><label for="correo">Correo:</label></td><td><input autocomplete="off" class="form-control" name="correo" type="email" value="<?php echo $result ['correo']; ?>" required></td>
...
<td>
  ...
  <a href="consultaE.php" style="margin-left:20px;"><span class="glyphicon glyphicon-arrow-left" style="font-size:24px;"></span></a> <br><br>
