...
$audit->insauditoria($admin, $_SESSION['identidad'],"Eliminó el registro del  estudiante: <font color=RED><i>" .$_POST['cedula']. " " .$_POST['nombre'] ." " .$_POST['apellido']. "</i></font>", " Usuario: " .$_SESSION['user'], "".$_SERVER['REMOTE_ADDR']);
...
<p><h4 align="center">El registro del estudiante ha sido eliminado correctamente. <span class="glyphicon glyphicon-ok"></span></h4></p>
</div>
