...
$a= new Usuarios();
$data=$a->VereQUIPbaloncesto($_SESSION['identidad']);
...
<td width="78%" >
 ...
 <table width="100%" border="0"      style="background-color:#fff;">
  <tr>
    <td colspan="3"><h3  ><span style="margin-left:20px;"  ><b style="font-family:bold;"> ELIJA SU EQUIPO</b></span></h3>   
</td>
...
<td align="center">
 ...
 <form method="POST" action="regisjugadore.php"> 
...
<br><br>
<img src="img/27351.png" width="130">
...
<td>
  ...
  <a href="selectjugador.php" style="margin-left:20px;"><span class="glyphicon glyphicon-arrow-left" style="font-size:24px;"></span></a> <br><br>
