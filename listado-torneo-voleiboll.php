...
foreach($data as $r){ 
  ...
  echo "<td ><a style='font-size:20px;' href='resultado-listado-torneo-voleiboll.php?id=$r->idtorneo';\"><img src='img/volleyball_97607.jpg' width='66'> $r->nombretorneo</a></td>";
