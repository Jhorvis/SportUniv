...
$audit->insauditoria($admin, $_SESSION['identidad'],"Reinicio la fase previa de un torneo", " Usuario: " .$_SESSION['user'], "".$_SERVER['REMOTE_ADDR']);
...
$a->actualizaposeliminatoria2($_GET ['id']);
...
<div class="alert alert-danger">
 ...
 <center> ¿Seguro desea reactivar la primera fase de este torneo?</center>
...
<tr>
 ...
 <td><center><input type ="submit" class="btn btn-primary" name="procesar" value="Si, Reactivar"></center></td>
</tr>
