...
$a= new Usuarios();
$data=$a->VerNotificacionesbaloncesto(-1);
...
<a href='aprobar-inscripcion-baloncesto.php?id=$rr->idequipo';\"><img id='img' src='img/unchecked_checkbox.png' width='27' height='27'></a></td>";
