...
$audit->insauditoria($admin, $_SESSION['identidad'],"Modificó el nombre del torneo: <font color=blue><i>" .$_POST['nombre']. " </i></font>", " Usuario: " .$_SESSION['user'], "".$_SERVER['REMOTE_ADDR']);
...
<td><label for="nombre"  >Nombres:</label></td><td><input  autofocus autocomplete="off"  class="form-control" name="nombre" type="text" value="<?php echo $result ['nombretorneo']; ?>"required></td>
</tr>
