...
<input value="1" name="nivel" type="hidden"> 
...
<td><label for="nombre">Nombres</label></td><td><input autocomplete="off" onkeypress="txNombres()"class="form-control" name="nombre" type="text" required></td>
...
<td><label for="pass">Contraseña</label></td><td><input class="form-control" autocomplete="off"  name="pass" type="password" placeholder="minimo 5 caracteres"
pattern="[A-Za-z0-9]{5,10}" required></td>
