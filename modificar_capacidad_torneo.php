...
$p->actualizaequitorneo(
       $id,
       $_POST['cantidadequipos']
       );
...
$audit->insauditoria($admin, $_SESSION['identidad'],"Modificó la cantidad de equipos a: <font color=blue><i>" .$_POST['cantidadequipos']. " </i></font>", " Usuario: " .$_SESSION['user'], "".$_SERVER['REMOTE_ADDR']);
...
';
        ...
        $modificarest = "SELECT * FROM registorneo where idtorneo = $id";
...
<table width="100%" border="0"      style="background-color:#fff;">
  <tr>
    <td colspan="3"><h3  ><span style="margin-left:20px;"class="glyphicon glyphicon-search"  ><b style="font-family:bold;"> NOMBRE DEL TORNEO </b></span></h3>   
 </td>
...
<td><label for="nombre"  >Cantidad de equipos:</label></td><td><input  autofocus autocomplete="off" onkeypress="ValidaSoloNumeros()"  class="form-control" name="cantidadequipos" type="text" value="<?php echo $result ['cantidaequi']; ?>"required></td>
</tr>
