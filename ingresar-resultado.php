...
$datas=$a->ListadoEquipostabla($torneo);
...
<?php $idequipoba = $rs->idequipo;   ?>




 <?php $a->actualizatablapos($idequipoba, $pos); }  ?>
...
$a->regisresultados (
 ...
 $a->regisposicion1($_POST ['equipo_local'],$play1,$win1, $loss1, $torneo, $idequipoa, $_POST['goles_local'] , $_POST ['goles_visitante'], $diferencia, $draw1, $puntos1);
 // funcion para actualizar estatus del encuentro
   $a->actualizarestatusencuentro ($_POST["encuentro"], $_POST["estatus"]);
...
$nombrequipo2 = $_POST ['equipo_visitante'];
$buscarequipo1 = "SELECT * from regisequipo WHERE torneo = $torneo AND nombrequipo ='$nombrequipo2'";
$consulta2 = mysql_query($buscarequipo1);
$resultado2 = mysql_fetch_array($consulta2);
$idequipob = $resultado2 ['idequipo'];
...
//);
 ...
 $a->regisposicion2($_POST ['equipo_visitante'],$play2,$win2, $loss2, $torneo, $idequipob, $_POST['goles_local'] , $_POST ['goles_visitante'], $diferencia2, $draw2, $puntos2);
 // funcion para actualizar estatus del encuentro
   $a->actualizarestatusencuentro ($_POST["encuentro"], $_POST["estatus"]);
