...
<META HTTP-EQUIV=Refresh CONTENT="0; URL=agregar-articulo.php?id=<?php echo $_GET ['id'];?>">
...
<input name="emprestar" type="number" class="form-control" placeholder="Cantidad..."> <br>
