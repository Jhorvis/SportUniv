...
<div align="center">
<br>
 <a href="nuevo-equipo-baloncesto.php" class="btn btn-primary" >Volver Atras</a>
...
<form method="post" action="nuevo-equipo-baloncesto.php">
...
<input type="hidden"   class="form-control" name="disciplina"  value="Baloncesto" required>
...
<td>
  ...
  <a href="nuevo-equipo-baloncesto.php" style="margin-left:20px;"><span class="glyphicon glyphicon-arrow-left" style="font-size:24px;"></span></a> <br><br>
