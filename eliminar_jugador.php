...
$sentencia = "select * from regisjugadore where idjugadore=$id";
$queryy= mysql_query($sentencia);
$arreglo = mysql_fetch_array($queryy);
$carrera = $arreglo['carrera'];

$sentencia2 = "select * from estudiantestorneo where carrera='$carrera'";
$queryyy= mysql_query($sentencia2);
$arreglo2 = mysql_fetch_array($queryyy);
$idcarrera = $arreglo2['idestudiantetorneo'];
$cantidadactual = $arreglo2['cantidad'];

$total = $cantidadactual -1;

$sentenciaupdate ="UPDATE estudiantestorneo set idestudiantetorneo=$idcarrera,
cantidad=$total WHERE idestudiantetorneo=$idcarrera";
$queryyyy= mysql_query($sentenciaupdate);



$data=$a->eliminarugador($_GET ['id']);
...
<a href='http://localhost/aplicacion-jhorvis2/regisjugadore.php\"> <input  class='btn btn-primary' value='Volver atras'></a>
...
<div class="alert alert-danger">
 ...
 <center> ¿Seguro desea eliminar el registro de este Jugador??</center>
