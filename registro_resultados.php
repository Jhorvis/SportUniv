...
<div class="featurede" align="center" > 
 ...
 <table width="100%" border="0"      style="background-color:#fff;">
  <tr>
    <td colspan="3"><h3  ><span style="margin-left:20px;"  ><b style="font-family:bold;"> ELIJA SU TORNEO DE FUTBOL</b></span></h3>   
</td>
...
foreach($data as $r){ 
  ...
  echo "<td align='center'><a style='font-size:24px;' href='nuevo_resultado.php?id=$r->idtorneo';\"><img src='img/Iconofutbol.png' width='66'> $r->nombretorneo</a></td>";
...
<td>
  ...
  <a href="tipo_estadistica.php" style="margin-left:20px;"><span class="glyphicon glyphicon-arrow-left" style="font-size:24px;"></span></a> <br><br>
