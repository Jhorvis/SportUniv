...
<div class="featurede" align="center"   style="background-color:#fff;"> 
 ...
 <table width="100%" border="0"      style="background-color:#fff;">
  <tr>
    <td colspan="3"><h3  ><span style="margin-left:20px;"  ><b style="font-family:bold;"> LISTADO DEL TORNEO DE FUTBOL SALA  - SOLO SE PERMITE <span style="color:red;"><?PHP echo $rv->cantidaequi;?></span> EQUIPOS!</b></span></h3>   
</td>
